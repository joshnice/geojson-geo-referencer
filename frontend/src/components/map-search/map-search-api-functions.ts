...
const MAPBOX_SEARCH_API_URL_BASE = "https://api.mapbox.com/search/geocode/v6/forward";

const MAPBOX_SEARCH_API_TOKEN = "pk.eyJ1Ijoiam9zaG5pY2U5OCIsImEiOiJjanlrMnYwd2IwOWMwM29vcnQ2aWIwamw2In0.RRsdQF3s2hQ6qK-7BH5cKg";
